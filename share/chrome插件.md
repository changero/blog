...
- [SimpleExtManager](https://chrome.google.com/webstore/detail/simpleextmanager/kniehgiejgnnpgojkdhhjbgbllnfkfdk?utm_source=chrome-ntp-icon)，便捷的管理已有的扩展（最新版chrome已支持类似的功能）

<!-- more -->

- [bitwarden](https://chrome.google.com/webstore/detail/bitwarden-free-password-m/nngceckbapebfimnlniiiahkandclblb)，免费的密码管理器，支持APP。
